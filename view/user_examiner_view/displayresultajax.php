...
<tr><td></td><td><?php echo $total_perc; ?></td><td>
<?php echo $data_sum."/".$key['total_ques']; ?></td>
<td><?php echo gmdate("H:i:s", $totalDuration);?></td><td><?php echo $total_attempt; ?></td></tr>
</table>
<br>
<table>
<tr>
...
echo"<tr><td>".$key['first_name']." ".$key['last_name'].
"</td><td>".$data_perc.
"</td><td>".$key['score']."/".$key['total_ques'].
"</td><td>".$diff_time->format('%hh :%mm: %ss').
"</td><td><a href='getIndividualResults?id=".$key['id']."'>click  to View</a></td></tr>";
}
?>
</table>
</div>