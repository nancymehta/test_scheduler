...
<div id="registerdiv" class="registerdiv">
    ...
    <div class="login-strip">Register<span id="close1" class="close"> X</span></div>
            <div class=" val">
                ...
                "reg_password" name="password" type="password" onkeyup="check()" class="loginc"/>
...
$(function() {
    $( "#reg_dob" ).datepicker({
     ...
     $( "#reg_dob,#reg_age" ).attr("readonly", "readonly");
               ...
               <label class="label1"><?php echo "DOB"; ?><input id="reg_dob"name="date_of_birth" class="loginc" type="text" /></label>
            ...
            <select class="sel" id="reg_gender" name="gender">
                    <option>
                       <?php echo "MALE"; ?>
                    </option>
                ...
                <label class="label1"><?php echo "Country"; ?>&nbsp;&nbsp;<select class="sel" id="reg_country" name="country">
		<?php echo IMAGE_PATH;?>
                    <option>
                        India
