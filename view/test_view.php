...
<?php
    ...
    foreach ( $options as $val ) {
        ...
        if (! empty ( $val )) {
            ...
            if ($type == 6) {
                // echo "<input type='checkbox' name='coption'
...
<input type="hidden" name="controller" value="test">
		<div class="next_prev">
			<input type=submit name="function" value="prev"
				class="submmit_button_generic bg-fg-button-color"> <input
				type=submit name="function" value="next"
				class="submmit_button_generic bg-fg-button-color">
		</div>
