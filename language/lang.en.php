...
define('INVALID_EMAIL','please enter email in valid format');
define('INVALID_URL','you have not entered valid url');
define('VALID_URL','url is valid');
define('VALID_IP','This IP address is considered valid.');
define('INVALID_IP','This IP address is not valid');
...
define('INVALID_USERNAME','only alphanumeric, dot & underscore are permitted');
define('UNAME_LENGTH','Length must be between 5-20 characters');
define('UNAME_VALUE','Enter a value');
define('INVALID_PASS','invalid password');
define('INVALID_PASS_LENGTH','password length must be between 6 and 20 char');
define('INVALID_PHONE','enter digits only');
define('INVALID_PHONE_LENGTH','phone no. must between 8 and 15 characters long');
define('INVALID_FNAME','enter alphabatic value');
define('INVALID_FNAME_LENGTH','Length must be between 5 and 20 character');
